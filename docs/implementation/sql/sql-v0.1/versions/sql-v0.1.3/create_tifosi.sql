-- 🧱 Script create_tifosi.sql — Version MPD v0.1.3
-- Auteur : PerLucCo
-- Date : 2025-06-25

-- ⚠️ Réinitialisation de la base (supprime toutes les données existantes)
DROP DATABASE IF EXISTS tifosi_v013;

-- 🔧 Création de la base
CREATE DATABASE tifosi_v013 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
CREATE TABLE marques (
    ...
    nom_marquet VARCHAR(45) NOT NULL
) ENGINE = InnoDB;
